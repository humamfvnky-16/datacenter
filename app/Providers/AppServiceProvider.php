...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        View::composer('*', function ($view) {
            ...
            $view->with('AppCfg', [
                ...
                'logo'           => $localLogo,
                'favicon'        => $localFav,
                'logo_url'       => $brand['logo_url'] ?? ($localLogo ? Storage::disk('public')->url($localLogo) : null),
                'favicon_url'    => $brand['logo_url'] ?? ($localFav ? Storage::disk('public')->url($localFav) : null),
    ...
    protected function schoolBranding(): array
    {
        ...
        $logoUrl = ($sekolah && $sekolah->logo) ? Storage::disk('public')->url($sekolah->logo) : null;
